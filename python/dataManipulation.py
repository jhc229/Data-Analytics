...
import os
os.chdir('C:/Users/Data-Analytics/OneDrive/pythonProject')
os.getcwd()
...
df_wine.head()
df_wine = df_wine.groupby('quality').apply(ranker) #split and apply
df_wine.head(10)
...
##### Cross-Tabulation fro frequnency tables
